                            ...
                            <div class="row">
                                    <div class="col-md-3 border-right mt-4">
                                        <div class="d-flex flex-column align-items-center text-center p-3">
                                            <img class="rounded-circle mb-2" width="150px" src="./assets/img/logodaw.png">
                                        ...
                                        <span class="text-black-50">testtestestes@gmail.com</span>
                                        <span> </span>
                                    </div>
                                    </div>
                                    <div class="col-md-9 border-right">
                                        <form id="update_profile_form" enctype="multipart/form-data">
                                            ...
                                            <div class="p-3 py-5">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-md-6"><label class="labels">Name</label><input type="text" class="form-control" placeholder="Fullname" value="" id="name" name="name" required></div>
                                                    <div class="col-md-6"><label class="labels">Username</label><input type="text" class="form-control" value="" placeholder="Username" id="username" name="username" required></div>
                                                </div>
                                                <div class="row mt-2">

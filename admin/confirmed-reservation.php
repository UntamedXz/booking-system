                                  ...
                                  <table id="tableData" class="table table-hover">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="text-dark text-md opacity-10 ps-2">Confirmed Date</th>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?= date('M-d-y h:i A', strtotime($row['confirmed_date'])); ?></td>
                                        <td><?= $row['status'] ?></td>

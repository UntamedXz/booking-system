                            ...
                            <div class="card my-4">
                              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow- border-radius-lg pt-4 pb-3">
                                  <h4 class="text-dark text-uppercase ps-3 text-left">Confirmed Reservations</h4>
                                </div>
                              </div>
                              <div class="card-body">
                                <?php 
                                  ...
                                  <table id="tableData" class="table table-hover">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="text-dark text-md opacity-10 ps-2">Checked In Date</th>
                                        <th class="text-dark text-md opacity-10 ps-2">Checked Out Date</th>
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td><?= date('M-d-y h:i A', strtotime($row['paid_date'])); ?></td>
                                        <?php 
                                        if($row['checked_in_date'] != '0000-00-00 00:00:00') {
                                            $checked_in = date('M-d-Y h:i A', strtotime($row['checked_in_date']));
                                        } else {
                                            $checked_in = 'N/A';
                                        }

                                        if($row['checked_out_date'] != '0000-00-00 00:00:00') {
                                            $checked_out = date('M-d-Y h:i A', strtotime($row['checked_out_date']));
                                        } else {
                                            $checked_out = 'N/A';
                                        }
                                        ?>
